...
def generate_and_save_model_performance(species, dense_or_sparse, path_data, r_s_id=None, formulation="GEM"):
    ...
    if formulation == "EDR-vertex":
        return EDR_generate_and_save(species, path_data, task_id=r_s_id, number_of_parcels=number_of_parcels)

    elif formulation == "distance-atlas":
        return distance_atlas_generate_and_save(species, path_data, number_of_parcels=number_of_parcels, repetition_id=r_s_id)

    elif formulation == "MI":
        return matching_index_generate_and_save(species, path_data, number_of_parcels=number_of_parcels, repetition_id=r_s_id)
